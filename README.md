...
## Assistant scaffold validation

The repository contains shared Claude Code and OpenCode project rules under `.claude/` and `.opencode/`. They are not part of the application build or runtime package.

Validate the scaffold with:

```powershell
python .claude\scripts\validate_scaffold.py
```

The active baseline is Qt 6.11, C++20, MSVC 2022, and CMake.
